...
def main():
    ...
    # only keep words that appear at least 20 times
    ...
    print(f"Trimmed Vocab Size (min_count=20): {vocab_size}")
    ...
    with open('/Users/JackYu_1/Desktop/STAT_359/stat359/student/Assignment_2/processed_data.pkl', 'wb') as f:
