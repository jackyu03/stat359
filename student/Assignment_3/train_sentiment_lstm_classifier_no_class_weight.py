...
plt.grid(True)
plt.tight_layout()
plt.savefig('outputs/lstm_unweighted_f1_learning_curves.png')
# plt.show()
print("Learning curves saved as 'outputs/lstm_unweighted_f1_learning_curves.png'.")
...
plt.grid(True)
plt.tight_layout()
plt.savefig('outputs/lstm_unweighted_accuracy_learning_curve.png')
# plt.show()
print("Accuracy curve saved as 'outputs/lstm_unweighted_accuracy_learning_curve.png'.")
...
plt.savefig('outputs/lstm_unweighted_confusion_matrix.png')
# plt.show()
print("Confusion matrix saved as 'outputs/lstm_unweighted_confusion_matrix.png'.")
# ========== Update Shared Metrics CSV ==========
print("\n========== Updating Shared Metrics CSV ==========")
metrics_path = 'outputs/shared_metrics.csv'
model_name = 'LSTM_Unweighted'
